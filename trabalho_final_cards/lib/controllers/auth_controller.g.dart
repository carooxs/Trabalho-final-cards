...
mixin _$AuthController on _AuthControllerBase, Store {
  ...
  final _$loginRepositoryAtom =
      Atom(name: '_AuthControllerBase.loginRepository');

  @override
  LoginState get loginRepository {
    _$loginRepositoryAtom.reportRead();
    return super.loginRepository;
  }

  @override
  set loginRepository(LoginState value) {
    _$loginRepositoryAtom.reportWrite(value, super.loginRepository, () {
